...
長文脈——出荷するサービング窓は262144トークンですが、上のprobeは
...
- 複数ターンの会話、tool呼び出し、指示追従、長文脈——出荷する窓は
  262144トークンですが、それに近い長さのプロンプトでは何も測って
