...
長文脈——出荷するサービング窓は307200トークンですが、上のprobeは
...
`--max-model-len 307200`、`--max-num-seqs 2`、
...
- 複数ターンの会話、tool呼び出し、指示追従、長文脈——出荷する窓は
  307200トークンですが、それに近い長さのプロンプトでは何も測って
